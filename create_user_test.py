...
def negative_assert_symbol(first_name):
    ...
    # Проверяется, что в ответе атрибут message такой
...
# Параметр fisrtName состоит из руских букв
...
# Тест 10. Ошибка создания пользователя
...
# Тест 11. Ошибка создания пользователя
# Передано пустое значение параметра fisrtName
...
# Тест 12. Ошибка создания пользователя
